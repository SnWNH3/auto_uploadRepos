...
# create_inputjson.py
测试用脚本，用于快速生成input.json，已加入.gitignore中
...
将github返回的仓库信息，转换成上传脚本所需的格式
同时筛选掉大小大于100GB的仓库

# test_repoMange.py
平台资源管理脚本，主要实现四个功能：
1.删除空仓库，判断逻辑仓库文件数为1且文件名为readme.md
2.过滤特定标签仓库
3.资源仓库==>本地excel
4.本地excel ==> input.json，包含查重功能
